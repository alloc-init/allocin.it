      ...
      - icon:
        ...
        text: |
          **\[\[alloc] init]** is a cryptography research and development company committed to bringing more expressivity to Bitcoin - without altering its core protocol or compromising its foundational principles.
          ...
          Our mission is to advance Bitcoin's adoption and evolution by extending its functionality via cryptographically-enforced covenants (advanced spending conditions) and non-interactive zero-knowledge proofs on Bitcoin L1 itself — not other chains or side systems. We aim to position Bitcoin as the substrate for the next generation of financial and social infrastructure - remaining immutable, yet increasingly capable.
      - icon:
          name: ''
          color: ''
          style: float
