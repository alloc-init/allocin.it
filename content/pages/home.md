      ...
      - icon:
        ...
        text: |
          **\[\[alloc] init]** is a cryptography research and development company committed to bringing more expressivity to Bitcoin - without altering its core protocol or foundational principles.
          ...
          Our mission is to advance Bitcoin's evolution and degree of expressivity by extending its functionality via cryptographically-enforced covenants and non-interactive zero-knowledge proofs on the L1 itself — eliminating the need for users to trust alternative side systems. 
