...
blocks:
  ...
  - items:
      - icon:
        ...
        title: ABOUT US
        text: |
          **\[\[alloc] init]** is a cryptography research and development company committed to bringing more expressivity to Bitcoin - without altering its protocol or compromising its principles.
