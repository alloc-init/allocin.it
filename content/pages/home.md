  ...
  - items:
      ...
      - icon:
        ...
        text: |
          ...
          PIPEs introduce expressivity to Bitcoin by emulating missing covenant opcodes, enabling their implementations without requiring changes to Bitcoin’s core protocol. PIPEs introduce pessimistic zero-knowledge proofs (ZKPs) to Bitcoin, providing a promising path for use cases demanding scalability, programmability and privacy without relying on optimistic verification.
      - icon:
          name: ''
          color: ''
          style: float
